    ...
    module Node = struct
      ...
      module NestedNode = struct
        ...
        let name_get x =
          RA_.get_text ~default:"" x 0
        let id_get x =
          RA_.get_uint64 ~default:Stdint.Uint64.zero x 0
      ...
      module SourceInfo = struct
        ...
        module Member = struct
          type struct_t = [`Member_c2ba9038898e1fa2]
          type t = struct_t reader_t
          let has_doc_comment x =
            RA_.has_field x 0
          let doc_comment_get x =
            RA_.get_text ~default:"" x 0
          let of_message x = RA_.get_root_struct (RA_.Message.readonly x)
          let of_builder x = Some (RA_.StructStorage.readonly x)
        end
        ...
        let members_get_list x =
          Capnp.Array.to_list (members_get x)
        let members_get_array x =
          Capnp.Array.to_array (members_get x)
      ...
      let start_byte_get x =
        RA_.get_uint32 ~default:Stdint.Uint32.zero x 40
      let start_byte_get_int_exn x =
        Capnp.Runtime.Util.int_of_uint32_exn (start_byte_get x)
      let end_byte_get x =
        RA_.get_uint32 ~default:Stdint.Uint32.zero x 44
      let end_byte_get_int_exn x =
        Capnp.Runtime.Util.int_of_uint32_exn (end_byte_get x)
      let of_message x = RA_.get_root_struct (RA_.Message.readonly x)
      let of_builder x = Some (RA_.StructStorage.readonly x)
    ...
    module CodeGeneratorRequest = struct
      ...
      module RequestedFile = struct
        ...
        module FileSourceInfo = struct
          ...
          let has_identifiers x =
            RA_.has_field x 0
          let identifiers_get x = 
            RA_.get_struct_list x 0
          let identifiers_get_list x =
            Capnp.Array.to_list (identifiers_get x)
          let identifiers_get_array x =
            Capnp.Array.to_array (identifiers_get x)
          let of_message x = RA_.get_root_struct (RA_.Message.readonly x)
          let of_builder x = Some (RA_.StructStorage.readonly x)
        end
        let id_get x =
      ...
      let has_source_info x =
        RA_.has_field x 3
      let source_info_get x = 
        RA_.get_struct_list x 3
      let source_info_get_list x =
        Capnp.Array.to_list (source_info_get x)
      let source_info_get_array x =
        Capnp.Array.to_array (source_info_get x)
  ...
  module Builder = struct
    ...
    module Node = struct
      ...
      module NestedNode = struct
        ...
        let name_set x v =
          BA_.set_text x 0 v
        let id_get x =
          BA_.get_uint64 ~default:Stdint.Uint64.zero x 0
        let id_get_int_exn x =
          Capnp.Runtime.Util.int_of_uint64_exn (id_get x)
        let id_set x v =
          BA_.set_uint64 ~default:Stdint.Uint64.zero x 0 v
      ...
      module SourceInfo = struct
        ...
        let start_byte_set_int_exn x v = start_byte_set x (Capnp.Runtime.Util.uint32_of_int_exn v)
        let end_byte_get x =
        ...
        let end_byte_set_int_exn x v = end_byte_set x (Capnp.Runtime.Util.uint32_of_int_exn v)
      ...
      let annotations_set_array x v =
        ...
        builder
      let start_byte_get x =
        BA_.get_uint32 ~default:Stdint.Uint32.zero x 40
      let start_byte_get_int_exn x =
        Capnp.Runtime.Util.int_of_uint32_exn (start_byte_get x)
      let start_byte_set x v =
        BA_.set_uint32 ~default:Stdint.Uint32.zero x 40 v
      let start_byte_set_int_exn x v = start_byte_set x (Capnp.Runtime.Util.uint32_of_int_exn v)
      let end_byte_get x =
        BA_.get_uint32 ~default:Stdint.Uint32.zero x 44
      let end_byte_get_int_exn x =
        Capnp.Runtime.Util.int_of_uint32_exn (end_byte_get x)
      let end_byte_set x v =
        BA_.set_uint32 ~default:Stdint.Uint32.zero x 44 v
      let end_byte_set_int_exn x v = end_byte_set x (Capnp.Runtime.Util.uint32_of_int_exn v)
      let of_message x = BA_.get_root_struct ~data_words:6 ~pointer_words:6 x
      let to_message x = x.BA_.NM.StructStorage.data.MessageWrapper.Slice.msg
      let to_reader x = Some (RA_.StructStorage.readonly x)
    ...
    module Value = struct
      ...
      let uint32_get_int_exn x =
        Capnp.Runtime.Util.int_of_uint32_exn (uint32_get x)
      let uint32_set x v =
        BA_.set_uint32 ~discr:{BA_.Discr.value=8; BA_.Discr.byte_ofs=0} ~default:Stdint.Uint32.zero x 4 v
      ...
      let uint64_get_int_exn x =
        Capnp.Runtime.Util.int_of_uint64_exn (uint64_get x)
      let uint64_set x v =
        BA_.set_uint64 ~discr:{BA_.Discr.value=9; BA_.Discr.byte_ofs=0} ~default:Stdint.Uint64.zero x 8 v
    ...
    module CodeGeneratorRequest = struct
          ...
          module Identifier = struct
            ...
            module Member = struct
              ...
              let parent_type_id_set x v =
                BA_.set_uint64 ~default:Stdint.Uint64.zero x 8 v
              let parent_type_id_set_int_exn x v = parent_type_id_set x (Capnp.Runtime.Util.uint64_of_int_exn v)
              let ordinal_get x =
                BA_.get_uint16 ~default:0 x 18
              let ordinal_set_exn x v =
                BA_.set_uint16 ~default:0 x 18 v
            ...
            let type_id_get_int_exn x =
              Capnp.Runtime.Util.int_of_uint64_exn (type_id_get x)
            let type_id_set x v =
              BA_.set_uint64 ~discr:{BA_.Discr.value=0; BA_.Discr.byte_ofs=16} ~default:Stdint.Uint64.zero x 8 v
            let type_id_set_int_exn x v = type_id_set x (Capnp.Runtime.Util.uint64_of_int_exn v)
      ...
      let has_nodes x =
        BA_.has_field x 0
      let nodes_get x = 
        BA_.get_struct_list ~data_words:6 ~pointer_words:6 x 0
      let nodes_get_list x =
        Capnp.Array.to_list (nodes_get x)
      let nodes_get_array x =
        Capnp.Array.to_array (nodes_get x)
