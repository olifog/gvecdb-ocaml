  ...
  module Reader : sig
    ...
    module Node : sig
      ...
      module SourceInfo : sig
        ...
        val end_byte_get_int_exn : t -> int
        val of_message : 'cap message_t -> t
        val of_builder : struct_t builder_t -> t
      end
      ...
      val display_name_prefix_length_get : t -> Stdint.Uint32.t
    ...
    module Value : sig
      ...
      type unnamed_union_t =
        ...
        | Uint8 of int
        | Uint16 of int
        | Uint32 of Stdint.Uint32.t
        | Uint64 of Stdint.Uint64.t
        | Float32 of float
        | Float64 of float
        | Text of string
        | Data of string
    ...
    module CodeGeneratorRequest : sig
      ...
      val source_info_get : t -> (ro, Node.SourceInfo.t, array_t) Capnp.Array.t
  ...
  module Builder : sig
    ...
    module Node : sig
      ...
      module SourceInfo : sig
        ...
        val start_byte_set_int_exn : t -> int -> unit
        val end_byte_get : t -> Stdint.Uint32.t
        val end_byte_get_int_exn : t -> int
        val end_byte_set : t -> Stdint.Uint32.t -> unit
        val end_byte_set_int_exn : t -> int -> unit
        val of_message : rw message_t -> t
        val to_message : t -> rw message_t
        val to_reader : t -> struct_t reader_t
        val init_root : ?message_size:int -> unit -> t
      ...
      val display_name_prefix_length_get : t -> Stdint.Uint32.t
      val display_name_prefix_length_get_int_exn : t -> int
      val display_name_prefix_length_set : t -> Stdint.Uint32.t -> unit
    ...
    module Value : sig
      ...
      val uint32_set : t -> Stdint.Uint32.t -> unit
      val uint32_set_int_exn : t -> int -> unit
      val uint64_set : t -> Stdint.Uint64.t -> unit
        ...
        module FileSourceInfo : sig
          ...
          module Identifier : sig
            ...
            module Member : sig
              ...
              val parent_type_id_set_int_exn : t -> int -> unit
              val ordinal_get : t -> int
              val ordinal_set_exn : t -> int -> unit
              val of_message : rw message_t -> t
              val to_message : t -> rw message_t
              val to_reader : t -> struct_t reader_t
              val init_root : ?message_size:int -> unit -> t
  ...
  module Reader = struct
    ...
    module Node = struct
      ...
      module Struct = struct
        ...
        let data_word_count_get x = RA_.get_uint16 ~default:0 x 14
        let pointer_count_get x = RA_.get_uint16 ~default:0 x 24
        ...
        let discriminant_count_get x = RA_.get_uint16 ~default:0 x 30

        let discriminant_offset_get x =
          RA_.get_uint32 ~default:Stdint.Uint32.zero x 32

        let discriminant_offset_get_int_exn x =
          Capnp.Runtime.Util.int_of_uint32_exn (discriminant_offset_get x)

        let has_fields x = RA_.has_field x 3
        let fields_get x = RA_.get_struct_list x 3
        let fields_get_list x = Capnp.Array.to_list (fields_get x)
        let fields_get_array x = Capnp.Array.to_array (fields_get x)
      ...
      module Enum = struct
        ...
        let has_enumerants x = RA_.has_field x 3
        let enumerants_get x = RA_.get_struct_list x 3
        let enumerants_get_list x = Capnp.Array.to_list (enumerants_get x)
        let enumerants_get_array x = Capnp.Array.to_array (enumerants_get x)
        let of_message x = RA_.get_root_struct (RA_.Message.readonly x)
        let of_builder x = Some (RA_.StructStorage.readonly x)
      end
      ...
      module Interface = struct
        ...
        let has_methods x = RA_.has_field x 3
        let methods_get x = RA_.get_struct_list x 3
        let methods_get_list x = Capnp.Array.to_list (methods_get x)
        let methods_get_array x = Capnp.Array.to_array (methods_get x)
        let has_superclasses x = RA_.has_field x 4
        let superclasses_get x = RA_.get_struct_list x 4
        let superclasses_get_list x = Capnp.Array.to_list (superclasses_get x)
        let superclasses_get_array x = Capnp.Array.to_array (superclasses_get x)
        let of_message x = RA_.get_root_struct (RA_.Message.readonly x)
        let of_builder x = Some (RA_.StructStorage.readonly x)
      end
      ...
      module Const = struct
        ...
        let has_type x = RA_.has_field x 3
        let type_get x = RA_.get_struct x 3
        let type_get_pipelined x = MessageWrapper.Untyped.struct_field x 3
        let has_value x = RA_.has_field x 4
        let value_get x = RA_.get_struct x 4
        let value_get_pipelined x = MessageWrapper.Untyped.struct_field x 4
        let of_message x = RA_.get_root_struct (RA_.Message.readonly x)
        let of_builder x = Some (RA_.StructStorage.readonly x)
      end
      ...
      module NestedNode = struct
        ...
        let has_name x = RA_.has_field x 0
        let name_get x = RA_.get_text ~default:"" x 0
        let id_get x = RA_.get_uint64 ~default:Stdint.Uint64.zero x 0
        let id_get_int_exn x = Capnp.Runtime.Util.int_of_uint64_exn (id_get x)
        let of_message x = RA_.get_root_struct (RA_.Message.readonly x)
        let of_builder x = Some (RA_.StructStorage.readonly x)
      end
      ...
      module SourceInfo = struct
        ...
        module Member = struct
          ...
          let has_doc_comment x = RA_.has_field x 0
          let doc_comment_get x = RA_.get_text ~default:"" x 0
          let of_message x = RA_.get_root_struct (RA_.Message.readonly x)
          let of_builder x = Some (RA_.StructStorage.readonly x)
        end
        ...
        let has_doc_comment x = RA_.has_field x 0
        let doc_comment_get x = RA_.get_text ~default:"" x 0
        let has_members x = RA_.has_field x 1
        let members_get x = RA_.get_struct_list x 1
        let members_get_list x = Capnp.Array.to_list (members_get x)
        let members_get_array x = Capnp.Array.to_array (members_get x)
        let start_byte_get x = RA_.get_uint32 ~default:Stdint.Uint32.zero x 8

        let start_byte_get_int_exn x =
          Capnp.Runtime.Util.int_of_uint32_exn (start_byte_get x)

        let end_byte_get x = RA_.get_uint32 ~default:Stdint.Uint32.zero x 12

        let end_byte_get_int_exn x =
          Capnp.Runtime.Util.int_of_uint32_exn (end_byte_get x)
      ...
      let id_get x = RA_.get_uint64 ~default:Stdint.Uint64.zero x 0
      let id_get_int_exn x = Capnp.Runtime.Util.int_of_uint64_exn (id_get x)
      let has_display_name x = RA_.has_field x 0
      let display_name_get x = RA_.get_text ~default:"" x 0
      ...
      let scope_id_get x = RA_.get_uint64 ~default:Stdint.Uint64.zero x 16

      let scope_id_get_int_exn x =
        Capnp.Runtime.Util.int_of_uint64_exn (scope_id_get x)

      let has_parameters x = RA_.has_field x 5
      let parameters_get x = RA_.get_struct_list x 5
      let parameters_get_list x = Capnp.Array.to_list (parameters_get x)
      let parameters_get_array x = Capnp.Array.to_array (parameters_get x)

      let is_generic_get x =
        RA_.get_bit ~default:false x ~byte_ofs:36 ~bit_ofs:0

      let has_nested_nodes x = RA_.has_field x 1
      let nested_nodes_get x = RA_.get_struct_list x 1
      let nested_nodes_get_list x = Capnp.Array.to_list (nested_nodes_get x)
      let nested_nodes_get_array x = Capnp.Array.to_array (nested_nodes_get x)
      let has_annotations x = RA_.has_field x 2
      let annotations_get x = RA_.get_struct_list x 2
      let annotations_get_list x = Capnp.Array.to_list (annotations_get x)
      let annotations_get_array x = Capnp.Array.to_array (annotations_get x)
      let start_byte_get x = RA_.get_uint32 ~default:Stdint.Uint32.zero x 40

      let start_byte_get_int_exn x =
        Capnp.Runtime.Util.int_of_uint32_exn (start_byte_get x)

      let end_byte_get x = RA_.get_uint32 ~default:Stdint.Uint32.zero x 44
    ...
    module Field = struct
      ...
      module Slot = struct
        ...
        let offset_get x = RA_.get_uint32 ~default:Stdint.Uint32.zero x 4

        let offset_get_int_exn x =
          Capnp.Runtime.Util.int_of_uint32_exn (offset_get x)

        let has_type x = RA_.has_field x 2
        let type_get x = RA_.get_struct x 2
        let type_get_pipelined x = MessageWrapper.Untyped.struct_field x 2
        let has_default_value x = RA_.has_field x 3
        let default_value_get x = RA_.get_struct x 3
      ...
      module Group = struct
        ...
        let type_id_get x = RA_.get_uint64 ~default:Stdint.Uint64.zero x 16
      ...
      module Ordinal = struct
        ...
        let implicit_get x = ()
        let explicit_get x = RA_.get_uint16 ~default:0 x 12
      ...
      let has_name x = RA_.has_field x 0
      let name_get x = RA_.get_text ~default:"" x 0
      let code_order_get x = RA_.get_uint16 ~default:0 x 0
      let has_annotations x = RA_.has_field x 1
      let annotations_get x = RA_.get_struct_list x 1
      let annotations_get_list x = Capnp.Array.to_list (annotations_get x)
      let annotations_get_array x = Capnp.Array.to_array (annotations_get x)
      let discriminant_value_get x = RA_.get_uint16 ~default:65535 x 2
    ...
    module Superclass = struct
      ...
      let id_get x = RA_.get_uint64 ~default:Stdint.Uint64.zero x 0
      let id_get_int_exn x = Capnp.Runtime.Util.int_of_uint64_exn (id_get x)
      let has_brand x = RA_.has_field x 0
      let brand_get x = RA_.get_struct x 0
      let brand_get_pipelined x = MessageWrapper.Untyped.struct_field x 0
      let of_message x = RA_.get_root_struct (RA_.Message.readonly x)
      let of_builder x = Some (RA_.StructStorage.readonly x)
    end
    ...
    module Method = struct
      ...
      let name_get x = RA_.get_text ~default:"" x 0
      let code_order_get x = RA_.get_uint16 ~default:0 x 0
      let has_implicit_parameters x = RA_.has_field x 4
      let implicit_parameters_get x = RA_.get_struct_list x 4
      ...
      let param_struct_type_get x =
        RA_.get_uint64 ~default:Stdint.Uint64.zero x 8

      let param_struct_type_get_int_exn x =
        Capnp.Runtime.Util.int_of_uint64_exn (param_struct_type_get x)

      let has_param_brand x = RA_.has_field x 2
      let param_brand_get x = RA_.get_struct x 2
      let param_brand_get_pipelined x = MessageWrapper.Untyped.struct_field x 2

      let result_struct_type_get x =
        RA_.get_uint64 ~default:Stdint.Uint64.zero x 16

      let result_struct_type_get_int_exn x =
        Capnp.Runtime.Util.int_of_uint64_exn (result_struct_type_get x)

      let has_result_brand x = RA_.has_field x 3
      let result_brand_get x = RA_.get_struct x 3
      let result_brand_get_pipelined x = MessageWrapper.Untyped.struct_field x 3
      let has_annotations x = RA_.has_field x 1
      let annotations_get x = RA_.get_struct_list x 1
      let annotations_get_list x = Capnp.Array.to_list (annotations_get x)
      let annotations_get_array x = Capnp.Array.to_array (annotations_get x)
    ...
    module Type = struct
      ...
      module List = struct
        ...
        let has_element_type x = RA_.has_field x 0
        let element_type_get x = RA_.get_struct x 0
      ...
      module Enum = struct
        ...
        let type_id_get x = RA_.get_uint64 ~default:Stdint.Uint64.zero x 8
      ...
      module AnyPointer = struct
        ...
        module Parameter = struct
          ...
          let parameter_index_get x = RA_.get_uint16 ~default:0 x 10
          let of_message x = RA_.get_root_struct (RA_.Message.readonly x)
          let of_builder x = Some (RA_.StructStorage.readonly x)
        end
    ...
    module Brand = struct
      ...
      module Scope = struct
        ...
        let has_bind x = RA_.has_field x 0
        let bind_get x = RA_.get_struct_list x 0
        let bind_get_list x = Capnp.Array.to_list (bind_get x)
        let bind_get_array x = Capnp.Array.to_array (bind_get x)
        let inherit_get x = ()
        ...
        let scope_id_get x = RA_.get_uint64 ~default:Stdint.Uint64.zero x 0
      ...
      module Binding = struct
        ...
        let unbound_get x = ()
        let has_type x = RA_.has_field x 0
        let type_get x = RA_.get_struct x 0
        let type_get_pipelined x = MessageWrapper.Untyped.struct_field x 0
      ...
      let has_scopes x = RA_.has_field x 0
      let scopes_get x = RA_.get_struct_list x 0
      let scopes_get_list x = Capnp.Array.to_list (scopes_get x)
      let scopes_get_array x = Capnp.Array.to_array (scopes_get x)
      let of_message x = RA_.get_root_struct (RA_.Message.readonly x)
      let of_builder x = Some (RA_.StructStorage.readonly x)
    end
    ...
    module Value = struct
      ...
      let void_get x = ()
      let bool_get x = RA_.get_bit ~default:false x ~byte_ofs:2 ~bit_ofs:0
      let int8_get x = RA_.get_int8 ~default:0 x 2
      let int16_get x = RA_.get_int16 ~default:0 x 2
      let int32_get x = RA_.get_int32 ~default:0l x 4

      let int32_get_int_exn x =
        Capnp.Runtime.Util.int_of_int32_exn (int32_get x)

      let int64_get x = RA_.get_int64 ~default:0L x 8

      let int64_get_int_exn x =
        Capnp.Runtime.Util.int_of_int64_exn (int64_get x)

      let uint8_get x = RA_.get_uint8 ~default:0 x 2
      let uint16_get x = RA_.get_uint16 ~default:0 x 2
      let uint32_get x = RA_.get_uint32 ~default:Stdint.Uint32.zero x 4

      let uint32_get_int_exn x =
        Capnp.Runtime.Util.int_of_uint32_exn (uint32_get x)

      let uint64_get x = RA_.get_uint64 ~default:Stdint.Uint64.zero x 8

      let uint64_get_int_exn x =
        Capnp.Runtime.Util.int_of_uint64_exn (uint64_get x)

      let float32_get x = RA_.get_float32 ~default_bits:0l x 4
      let float64_get x = RA_.get_float64 ~default_bits:0L x 8
      let has_text x = RA_.has_field x 0
      let text_get x = RA_.get_text ~default:"" x 0
      let has_data x = RA_.has_field x 0
      let data_get x = RA_.get_blob ~default:"" x 0
      let list_get x = RA_.get_pointer x 0
      let list_get_interface x = RA_.get_interface x 0
      let enum_get x = RA_.get_uint16 ~default:0 x 2
      let struct_get x = RA_.get_pointer x 0
      let struct_get_interface x = RA_.get_interface x 0
      let interface_get x = ()
      let any_pointer_get x = RA_.get_pointer x 0
      let any_pointer_get_interface x = RA_.get_interface x 0
    ...
    module Annotation = struct
      ...
      let id_get x = RA_.get_uint64 ~default:Stdint.Uint64.zero x 0
      let id_get_int_exn x = Capnp.Runtime.Util.int_of_uint64_exn (id_get x)
      let has_brand x = RA_.has_field x 1
      let brand_get x = RA_.get_struct x 1
      let brand_get_pipelined x = MessageWrapper.Untyped.struct_field x 1
      let has_value x = RA_.has_field x 0
      let value_get x = RA_.get_struct x 0
      let value_get_pipelined x = MessageWrapper.Untyped.struct_field x 0
      let of_message x = RA_.get_root_struct (RA_.Message.readonly x)
      let of_builder x = Some (RA_.StructStorage.readonly x)
    end
    ...
    module CapnpVersion = struct
      ...
      let major_get x = RA_.get_uint16 ~default:0 x 0
      let minor_get x = RA_.get_uint8 ~default:0 x 2
      let micro_get x = RA_.get_uint8 ~default:0 x 3
      let of_message x = RA_.get_root_struct (RA_.Message.readonly x)
      let of_builder x = Some (RA_.StructStorage.readonly x)
    end
    ...
    module CodeGeneratorRequest = struct
      ...
      module RequestedFile = struct
        ...
        module FileSourceInfo = struct
          ...
          module Identifier = struct
            ...
            module Member = struct
              ...
              let parent_type_id_get x =
                RA_.get_uint64 ~default:Stdint.Uint64.zero x 8

              let parent_type_id_get_int_exn x =
                Capnp.Runtime.Util.int_of_uint64_exn (parent_type_id_get x)

              let ordinal_get x = RA_.get_uint16 ~default:0 x 18
              let of_message x = RA_.get_root_struct (RA_.Message.readonly x)
              let of_builder x = Some (RA_.StructStorage.readonly x)
            end
            ...
            let member_get x = RA_.cast_struct x
            ...
            let get x =
              ...
              | 0 -> TypeId (type_id_get x)
              | 1 -> Member (member_get x)
              | v -> Undefined v

            let start_byte_get x =
              RA_.get_uint32 ~default:Stdint.Uint32.zero x 0

            let start_byte_get_int_exn x =
              Capnp.Runtime.Util.int_of_uint32_exn (start_byte_get x)

            let end_byte_get x = RA_.get_uint32 ~default:Stdint.Uint32.zero x 4
          ...
          let has_identifiers x = RA_.has_field x 0
          let identifiers_get x = RA_.get_struct_list x 0
          let identifiers_get_list x = Capnp.Array.to_list (identifiers_get x)
          let identifiers_get_array x = Capnp.Array.to_array (identifiers_get x)
          let of_message x = RA_.get_root_struct (RA_.Message.readonly x)
          let of_builder x = Some (RA_.StructStorage.readonly x)
        end
        ...
        let id_get x = RA_.get_uint64 ~default:Stdint.Uint64.zero x 0
        let id_get_int_exn x = Capnp.Runtime.Util.int_of_uint64_exn (id_get x)
        let has_filename x = RA_.has_field x 0
        let filename_get x = RA_.get_text ~default:"" x 0
        let has_imports x = RA_.has_field x 1
        let imports_get x = RA_.get_struct_list x 1
        let imports_get_list x = Capnp.Array.to_list (imports_get x)
        let imports_get_array x = Capnp.Array.to_array (imports_get x)
        let has_file_source_info x = RA_.has_field x 2
        let file_source_info_get x = RA_.get_struct x 2

        let file_source_info_get_pipelined x =
      ...
      let has_capnp_version x = RA_.has_field x 2
      let capnp_version_get x = RA_.get_struct x 2
      ...
      let has_source_info x = RA_.has_field x 3
      let source_info_get x = RA_.get_struct_list x 3
      let source_info_get_list x = Capnp.Array.to_list (source_info_get x)
      let source_info_get_array x = Capnp.Array.to_array (source_info_get x)
      let has_requested_files x = RA_.has_field x 1
      let requested_files_get x = RA_.get_struct_list x 1
  ...
  module Builder = struct
    ...
    module Node = struct
      ...
      module Struct = struct
        ...
        let data_word_count_get x = BA_.get_uint16 ~default:0 x 14
        let data_word_count_set_exn x v = BA_.set_uint16 ~default:0 x 14 v
        let pointer_count_get x = BA_.get_uint16 ~default:0 x 24
        let pointer_count_set_exn x v = BA_.set_uint16 ~default:0 x 24 v
        ...
        let preferred_list_encoding_set x e =
          BA_.set_uint16 ~default:0 x 26
            (ElementSize_15102134695616452902.encode_safe e)

        let preferred_list_encoding_set_unsafe x e =
          BA_.set_uint16 ~default:0 x 26
            (ElementSize_15102134695616452902.encode_unsafe e)
        ...
        let discriminant_count_get x = BA_.get_uint16 ~default:0 x 30
        let discriminant_count_set_exn x v = BA_.set_uint16 ~default:0 x 30 v

        let discriminant_offset_get x =
          BA_.get_uint32 ~default:Stdint.Uint32.zero x 32

        let discriminant_offset_get_int_exn x =
          Capnp.Runtime.Util.int_of_uint32_exn (discriminant_offset_get x)

        let discriminant_offset_set x v =
          BA_.set_uint32 ~default:Stdint.Uint32.zero x 32 v

        let discriminant_offset_set_int_exn x v =
          discriminant_offset_set x (Capnp.Runtime.Util.uint32_of_int_exn v)

        let has_fields x = BA_.has_field x 3
        ...
        let of_message x = BA_.get_root_struct ~data_words:6 ~pointer_words:6 x
        ...
        let init_root ?message_size () =
          BA_.alloc_root_struct ?message_size ~data_words:6 ~pointer_words:6 ()

        let init_pointer ptr =
          BA_.init_struct_pointer ptr ~data_words:6 ~pointer_words:6
      end
      ...
      module Enum = struct
        ...
        let has_enumerants x = BA_.has_field x 3
      ...
      module Interface = struct
        ...
        let has_methods x = BA_.has_field x 3
        ...
        let has_superclasses x = BA_.has_field x 4
      ...
      module Const = struct
        ...
        let has_type x = BA_.has_field x 3
        let type_get x = BA_.get_struct ~data_words:3 ~pointer_words:1 x 3
        ...
        let type_init x = BA_.init_struct ~data_words:3 ~pointer_words:1 x 3
        let has_value x = BA_.has_field x 4
        let value_get x = BA_.get_struct ~data_words:2 ~pointer_words:1 x 4
        ...
        let value_init x = BA_.init_struct ~data_words:2 ~pointer_words:1 x 4
        let of_message x = BA_.get_root_struct ~data_words:6 ~pointer_words:6 x
        let to_message x = x.BA_.NM.StructStorage.data.MessageWrapper.Slice.msg
        let to_reader x = Some (RA_.StructStorage.readonly x)
      ...
      module NestedNode = struct
        ...
        let name_get x = BA_.get_text ~default:"" x 0
        let name_set x v = BA_.set_text x 0 v
        let id_get x = BA_.get_uint64 ~default:Stdint.Uint64.zero x 0
        let id_get_int_exn x = Capnp.Runtime.Util.int_of_uint64_exn (id_get x)
        let id_set x v = BA_.set_uint64 ~default:Stdint.Uint64.zero x 0 v

        let id_set_int_exn x v =
          id_set x (Capnp.Runtime.Util.uint64_of_int_exn v)
      ...
      module SourceInfo = struct
        ...
        module Member = struct
          ...
          let has_doc_comment x = BA_.has_field x 0
          let doc_comment_get x = BA_.get_text ~default:"" x 0
          let doc_comment_set x v = BA_.set_text x 0 v

          let of_message x =
            BA_.get_root_struct ~data_words:0 ~pointer_words:1 x

          let to_message x =
            x.BA_.NM.StructStorage.data.MessageWrapper.Slice.msg
        ...
        let doc_comment_get x = BA_.get_text ~default:"" x 0
        let doc_comment_set x v = BA_.set_text x 0 v
        let has_members x = BA_.has_field x 1

        let members_get x =
          BA_.get_struct_list ~data_words:0 ~pointer_words:1 x 1

        let members_get_list x = Capnp.Array.to_list (members_get x)
        let members_get_array x = Capnp.Array.to_array (members_get x)

        let members_set x v =
          BA_.set_struct_list ~data_words:0 ~pointer_words:1 x 1 v

        let members_init x n =
          BA_.init_struct_list ~data_words:0 ~pointer_words:1 x 1 n

        let members_set_list x v =
          let builder = members_init x (List.length v) in
          let () = List.iteri (fun i a -> Capnp.Array.set builder i a) v in
          builder

        let members_set_array x v =
          let builder = members_init x (Array.length v) in
          let () = Array.iteri (fun i a -> Capnp.Array.set builder i a) v in
          builder

        let start_byte_get x = BA_.get_uint32 ~default:Stdint.Uint32.zero x 8

        let start_byte_get_int_exn x =
          Capnp.Runtime.Util.int_of_uint32_exn (start_byte_get x)

        let start_byte_set x v =
          BA_.set_uint32 ~default:Stdint.Uint32.zero x 8 v

        let start_byte_set_int_exn x v =
          start_byte_set x (Capnp.Runtime.Util.uint32_of_int_exn v)

        let end_byte_get x = BA_.get_uint32 ~default:Stdint.Uint32.zero x 12

        let end_byte_get_int_exn x =
          Capnp.Runtime.Util.int_of_uint32_exn (end_byte_get x)

        let end_byte_set x v = BA_.set_uint32 ~default:Stdint.Uint32.zero x 12 v

        let end_byte_set_int_exn x v =
          end_byte_set x (Capnp.Runtime.Util.uint32_of_int_exn v)
          ...
          let ptr =
            {
              ...
              MessageWrapper.Slice.start =
                pointers.MessageWrapper.Slice.start + 24;
          ...
          let ptr =
            {
              pointers with
              MessageWrapper.Slice.start =
                pointers.MessageWrapper.Slice.start + 32;
              MessageWrapper.Slice.len = 8;
            }
          in
          let () = BA_.BOps.deep_zero_pointer ptr in
      ...
      let has_display_name x = BA_.has_field x 0
      let display_name_get x = BA_.get_text ~default:"" x 0
      let display_name_set x v = BA_.set_text x 0 v
      ...
      let display_name_prefix_length_set_int_exn x v =
        display_name_prefix_length_set x
          (Capnp.Runtime.Util.uint32_of_int_exn v)

      let scope_id_get x = BA_.get_uint64 ~default:Stdint.Uint64.zero x 16

      let scope_id_get_int_exn x =
        Capnp.Runtime.Util.int_of_uint64_exn (scope_id_get x)

      let scope_id_set x v = BA_.set_uint64 ~default:Stdint.Uint64.zero x 16 v

      let scope_id_set_int_exn x v =
        scope_id_set x (Capnp.Runtime.Util.uint64_of_int_exn v)

      let has_parameters x = BA_.has_field x 5
      ...
      let has_nested_nodes x = BA_.has_field x 1
      ...
      let has_annotations x = BA_.has_field x 2
      ...
      let start_byte_get x = BA_.get_uint32 ~default:Stdint.Uint32.zero x 40

      let start_byte_get_int_exn x =
        Capnp.Runtime.Util.int_of_uint32_exn (start_byte_get x)

      let start_byte_set x v = BA_.set_uint32 ~default:Stdint.Uint32.zero x 40 v

      let start_byte_set_int_exn x v =
        start_byte_set x (Capnp.Runtime.Util.uint32_of_int_exn v)

      let end_byte_get x = BA_.get_uint32 ~default:Stdint.Uint32.zero x 44

      let end_byte_get_int_exn x =
        Capnp.Runtime.Util.int_of_uint32_exn (end_byte_get x)

      let end_byte_set x v = BA_.set_uint32 ~default:Stdint.Uint32.zero x 44 v
    ...
    module Field = struct
      ...
      module Slot = struct
        ...
        let offset_get x = BA_.get_uint32 ~default:Stdint.Uint32.zero x 4

        let offset_get_int_exn x =
          Capnp.Runtime.Util.int_of_uint32_exn (offset_get x)

        let offset_set x v = BA_.set_uint32 ~default:Stdint.Uint32.zero x 4 v

        let offset_set_int_exn x v =
          offset_set x (Capnp.Runtime.Util.uint32_of_int_exn v)

        let has_type x = BA_.has_field x 2
        let type_get x = BA_.get_struct ~data_words:3 ~pointer_words:1 x 2
        ...
        let type_init x = BA_.init_struct ~data_words:3 ~pointer_words:1 x 2
        let has_default_value x = BA_.has_field x 3
      ...
      module Group = struct
        ...
        let type_id_get x = BA_.get_uint64 ~default:Stdint.Uint64.zero x 16

        let type_id_get_int_exn x =
          Capnp.Runtime.Util.int_of_uint64_exn (type_id_get x)

        let type_id_set x v = BA_.set_uint64 ~default:Stdint.Uint64.zero x 16 v

        let type_id_set_int_exn x v =
          type_id_set x (Capnp.Runtime.Util.uint64_of_int_exn v)
      ...
      module Ordinal = struct
        ...
        let explicit_get x = BA_.get_uint16 ~default:0 x 12

        let explicit_set_exn x v =
          BA_.set_uint16
            ~discr:{ BA_.Discr.value = 1; BA_.Discr.byte_ofs = 10 }
            ~default:0 x 12 v
          ...
          let ptr =
            {
              pointers with
              MessageWrapper.Slice.start =
                pointers.MessageWrapper.Slice.start + 16;
              MessageWrapper.Slice.len = 8;
            }
          in
          let () = BA_.BOps.deep_zero_pointer ptr in
      ...
      let name_get x = BA_.get_text ~default:"" x 0
      let name_set x v = BA_.set_text x 0 v
      let code_order_get x = BA_.get_uint16 ~default:0 x 0
      let code_order_set_exn x v = BA_.set_uint16 ~default:0 x 0 v
      let has_annotations x = BA_.has_field x 1
      ...
      let discriminant_value_get x = BA_.get_uint16 ~default:65535 x 2
      let discriminant_value_set_exn x v = BA_.set_uint16 ~default:65535 x 2 v
    ...
    module Superclass = struct
      ...
      let id_set x v = BA_.set_uint64 ~default:Stdint.Uint64.zero x 0 v
      let id_set_int_exn x v = id_set x (Capnp.Runtime.Util.uint64_of_int_exn v)
      let has_brand x = BA_.has_field x 0
      let brand_get x = BA_.get_struct ~data_words:0 ~pointer_words:1 x 0
      ...
      let brand_init x = BA_.init_struct ~data_words:0 ~pointer_words:1 x 0
      let of_message x = BA_.get_root_struct ~data_words:1 ~pointer_words:1 x
      let to_message x = x.BA_.NM.StructStorage.data.MessageWrapper.Slice.msg
      let to_reader x = Some (RA_.StructStorage.readonly x)
    ...
    module Method = struct
      ...
      let code_order_get x = BA_.get_uint16 ~default:0 x 0
      let code_order_set_exn x v = BA_.set_uint16 ~default:0 x 0 v
      let has_implicit_parameters x = BA_.has_field x 4
      ...
      let param_struct_type_get x =
        BA_.get_uint64 ~default:Stdint.Uint64.zero x 8

      let param_struct_type_get_int_exn x =
        Capnp.Runtime.Util.int_of_uint64_exn (param_struct_type_get x)

      let param_struct_type_set x v =
        BA_.set_uint64 ~default:Stdint.Uint64.zero x 8 v

      let param_struct_type_set_int_exn x v =
        param_struct_type_set x (Capnp.Runtime.Util.uint64_of_int_exn v)

      let has_param_brand x = BA_.has_field x 2
      let param_brand_get x = BA_.get_struct ~data_words:0 ~pointer_words:1 x 2
      ...
      let result_struct_type_get x =
        BA_.get_uint64 ~default:Stdint.Uint64.zero x 16

      let result_struct_type_get_int_exn x =
        Capnp.Runtime.Util.int_of_uint64_exn (result_struct_type_get x)

      let result_struct_type_set x v =
        BA_.set_uint64 ~default:Stdint.Uint64.zero x 16 v

      let result_struct_type_set_int_exn x v =
        result_struct_type_set x (Capnp.Runtime.Util.uint64_of_int_exn v)

      let has_result_brand x = BA_.has_field x 3
      let result_brand_get x = BA_.get_struct ~data_words:0 ~pointer_words:1 x 3
    ...
    module Type = struct
      ...
      module List = struct
        ...
        let has_element_type x = BA_.has_field x 0
      ...
      module Enum = struct
        ...
        let type_id_get x = BA_.get_uint64 ~default:Stdint.Uint64.zero x 8

        let type_id_get_int_exn x =
          Capnp.Runtime.Util.int_of_uint64_exn (type_id_get x)

        let type_id_set x v = BA_.set_uint64 ~default:Stdint.Uint64.zero x 8 v
      ...
      module AnyPointer = struct
        ...
        module Unconstrained = struct
          ...
          let any_kind_set x =
            BA_.set_void
              ~discr:{ BA_.Discr.value = 0; BA_.Discr.byte_ofs = 10 }
              x
          ...
          let list_set x =
            BA_.set_void
              ~discr:{ BA_.Discr.value = 2; BA_.Discr.byte_ofs = 10 }
              x
          ...
          let capability_set x =
            BA_.set_void
              ~discr:{ BA_.Discr.value = 3; BA_.Discr.byte_ofs = 10 }
              x
          ...
          let of_message x =
            BA_.get_root_struct ~data_words:3 ~pointer_words:1 x
        ...
        module Parameter = struct
          ...
          let parameter_index_get x = BA_.get_uint16 ~default:0 x 10
          let parameter_index_set_exn x v = BA_.set_uint16 ~default:0 x 10 v
          ...
          let ptr =
            {
              pointers with
              MessageWrapper.Slice.start =
                pointers.MessageWrapper.Slice.start + 0;
              MessageWrapper.Slice.len = 8;
            }
          in
          let () = BA_.BOps.deep_zero_pointer ptr in
    ...
    module Brand = struct
      ...
      module Scope = struct
        ...
        let has_bind x = BA_.has_field x 0
        let bind_get x = BA_.get_struct_list ~data_words:1 ~pointer_words:1 x 0
        let bind_get_list x = Capnp.Array.to_list (bind_get x)
        let bind_get_array x = Capnp.Array.to_array (bind_get x)

        let bind_set x v =
          BA_.set_struct_list ~data_words:1 ~pointer_words:1
            ~discr:{ BA_.Discr.value = 0; BA_.Discr.byte_ofs = 8 }
            x 0 v

        let bind_init x n =
          BA_.init_struct_list ~data_words:1 ~pointer_words:1
            ~discr:{ BA_.Discr.value = 0; BA_.Discr.byte_ofs = 8 }
            x 0 n
        ...
        let scope_id_get x = BA_.get_uint64 ~default:Stdint.Uint64.zero x 0

        let scope_id_get_int_exn x =
          Capnp.Runtime.Util.int_of_uint64_exn (scope_id_get x)

        let scope_id_set x v = BA_.set_uint64 ~default:Stdint.Uint64.zero x 0 v
      ...
      module Binding = struct
        ...
        let has_type x = BA_.has_field x 0
        let type_get x = BA_.get_struct ~data_words:3 ~pointer_words:1 x 0

        let type_set_reader x v =
          BA_.set_struct ~data_words:3 ~pointer_words:1
            ~discr:{ BA_.Discr.value = 1; BA_.Discr.byte_ofs = 0 }
            x 0 v
        ...
        let type_init x =
          BA_.init_struct ~data_words:3 ~pointer_words:1
            ~discr:{ BA_.Discr.value = 1; BA_.Discr.byte_ofs = 0 }
            x 0
      ...
      let has_scopes x = BA_.has_field x 0
      let scopes_get x = BA_.get_struct_list ~data_words:2 ~pointer_words:1 x 0
      let scopes_get_list x = Capnp.Array.to_list (scopes_get x)
      let scopes_get_array x = Capnp.Array.to_array (scopes_get x)
    ...
    module Value = struct
      ...
      let bool_get x = BA_.get_bit ~default:false x ~byte_ofs:2 ~bit_ofs:0

      let bool_set x v =
        BA_.set_bit
          ~discr:{ BA_.Discr.value = 1; BA_.Discr.byte_ofs = 0 }
          ~default:false x ~byte_ofs:2 ~bit_ofs:0 v

      let int8_get x = BA_.get_int8 ~default:0 x 2

      let int8_set_exn x v =
        BA_.set_int8
          ~discr:{ BA_.Discr.value = 2; BA_.Discr.byte_ofs = 0 }
          ~default:0 x 2 v

      let int16_get x = BA_.get_int16 ~default:0 x 2

      let int16_set_exn x v =
        BA_.set_int16
          ~discr:{ BA_.Discr.value = 3; BA_.Discr.byte_ofs = 0 }
          ~default:0 x 2 v

      let int32_get x = BA_.get_int32 ~default:0l x 4
      ...
      let int32_set x v =
        BA_.set_int32
          ~discr:{ BA_.Discr.value = 4; BA_.Discr.byte_ofs = 0 }
          ~default:0l x 4 v

      let int32_set_int_exn x v =
        int32_set x (Capnp.Runtime.Util.int32_of_int_exn v)

      let int64_get x = BA_.get_int64 ~default:0L x 8
      ...
      let int64_set x v =
        BA_.set_int64
          ~discr:{ BA_.Discr.value = 5; BA_.Discr.byte_ofs = 0 }
          ~default:0L x 8 v

      let int64_set_int x v = int64_set x (Int64.of_int v)
      let uint8_get x = BA_.get_uint8 ~default:0 x 2

      let uint8_set_exn x v =
        BA_.set_uint8
          ~discr:{ BA_.Discr.value = 6; BA_.Discr.byte_ofs = 0 }
          ~default:0 x 2 v

      let uint16_get x = BA_.get_uint16 ~default:0 x 2

      let uint16_set_exn x v =
        BA_.set_uint16
          ~discr:{ BA_.Discr.value = 7; BA_.Discr.byte_ofs = 0 }
          ~default:0 x 2 v

      let uint32_get x = BA_.get_uint32 ~default:Stdint.Uint32.zero x 4
      ...
      let uint32_set x v =
        BA_.set_uint32
          ~discr:{ BA_.Discr.value = 8; BA_.Discr.byte_ofs = 0 }
          ~default:Stdint.Uint32.zero x 4 v

      let uint32_set_int_exn x v =
        uint32_set x (Capnp.Runtime.Util.uint32_of_int_exn v)

      let uint64_get x = BA_.get_uint64 ~default:Stdint.Uint64.zero x 8
      ...
      let uint64_set x v =
        BA_.set_uint64
          ~discr:{ BA_.Discr.value = 9; BA_.Discr.byte_ofs = 0 }
          ~default:Stdint.Uint64.zero x 8 v

      let uint64_set_int_exn x v =
        uint64_set x (Capnp.Runtime.Util.uint64_of_int_exn v)

      let float32_get x = BA_.get_float32 ~default_bits:0l x 4

      let float32_set x v =
        BA_.set_float32
          ~discr:{ BA_.Discr.value = 10; BA_.Discr.byte_ofs = 0 }
          ~default_bits:0l x 4 v

      let float64_get x = BA_.get_float64 ~default_bits:0L x 8

      let float64_set x v =
        BA_.set_float64
          ~discr:{ BA_.Discr.value = 11; BA_.Discr.byte_ofs = 0 }
          ~default_bits:0L x 8 v

      let has_text x = BA_.has_field x 0
      let text_get x = BA_.get_text ~default:"" x 0

      let text_set x v =
        BA_.set_text
          ~discr:{ BA_.Discr.value = 12; BA_.Discr.byte_ofs = 0 }
          x 0 v

      let has_data x = BA_.has_field x 0
      let data_get x = BA_.get_blob ~default:"" x 0

      let data_set x v =
        BA_.set_blob
          ~discr:{ BA_.Discr.value = 13; BA_.Discr.byte_ofs = 0 }
          x 0 v

      let list_get x = BA_.get_pointer x 0
      let list_get_interface x = BA_.get_interface x 0

      let list_set x v =
        BA_.set_pointer
          ~discr:{ BA_.Discr.value = 14; BA_.Discr.byte_ofs = 0 }
          x 0 (Some v)
      ...
      let enum_get x = BA_.get_uint16 ~default:0 x 2

      let enum_set_exn x v =
        BA_.set_uint16
          ~discr:{ BA_.Discr.value = 15; BA_.Discr.byte_ofs = 0 }
          ~default:0 x 2 v

      let struct_get x = BA_.get_pointer x 0
      let struct_get_interface x = BA_.get_interface x 0

      let struct_set x v =
        BA_.set_pointer
          ~discr:{ BA_.Discr.value = 16; BA_.Discr.byte_ofs = 0 }
          x 0 (Some v)
      ...
      let any_pointer_get x = BA_.get_pointer x 0
      let any_pointer_get_interface x = BA_.get_interface x 0

      let any_pointer_set x v =
        BA_.set_pointer
          ~discr:{ BA_.Discr.value = 18; BA_.Discr.byte_ofs = 0 }
          x 0 (Some v)
    ...
    module Annotation = struct
      ...
      let id_set x v = BA_.set_uint64 ~default:Stdint.Uint64.zero x 0 v
      let id_set_int_exn x v = id_set x (Capnp.Runtime.Util.uint64_of_int_exn v)
      let has_brand x = BA_.has_field x 1
      let brand_get x = BA_.get_struct ~data_words:0 ~pointer_words:1 x 1
      ...
      let brand_init x = BA_.init_struct ~data_words:0 ~pointer_words:1 x 1
      let has_value x = BA_.has_field x 0
      let value_get x = BA_.get_struct ~data_words:2 ~pointer_words:1 x 0
      ...
      let value_init x = BA_.init_struct ~data_words:2 ~pointer_words:1 x 0
      let of_message x = BA_.get_root_struct ~data_words:1 ~pointer_words:2 x
      let to_message x = x.BA_.NM.StructStorage.data.MessageWrapper.Slice.msg
      let to_reader x = Some (RA_.StructStorage.readonly x)
    ...
    module CapnpVersion = struct
      ...
      let major_get x = BA_.get_uint16 ~default:0 x 0
      let major_set_exn x v = BA_.set_uint16 ~default:0 x 0 v
      let minor_get x = BA_.get_uint8 ~default:0 x 2
      let minor_set_exn x v = BA_.set_uint8 ~default:0 x 2 v
      let micro_get x = BA_.get_uint8 ~default:0 x 3
      let micro_set_exn x v = BA_.set_uint8 ~default:0 x 3 v
    ...
    module CodeGeneratorRequest = struct
      ...
      module RequestedFile = struct
        ...
        module Import = struct
          ...
          let of_message x =
            BA_.get_root_struct ~data_words:1 ~pointer_words:1 x
        ...
        module FileSourceInfo = struct
          ...
          module Identifier = struct
            ...
            module Member = struct
              ...
              let parent_type_id_set x v =
                BA_.set_uint64 ~default:Stdint.Uint64.zero x 8 v

              let parent_type_id_set_int_exn x v =
                parent_type_id_set x (Capnp.Runtime.Util.uint64_of_int_exn v)

              let ordinal_get x = BA_.get_uint16 ~default:0 x 18
              let ordinal_set_exn x v = BA_.set_uint16 ~default:0 x 18 v

              let of_message x =
                BA_.get_root_struct ~data_words:3 ~pointer_words:0 x
              ...
              let init_root ?message_size () =
                BA_.alloc_root_struct ?message_size ~data_words:3
                  ~pointer_words:0 ()
            ...
            let type_id_set x v =
              BA_.set_uint64
                ~discr:{ BA_.Discr.value = 0; BA_.Discr.byte_ofs = 16 }
                ~default:Stdint.Uint64.zero x 8 v

            let type_id_set_int_exn x v =
              type_id_set x (Capnp.Runtime.Util.uint64_of_int_exn v)

            let member_get x = BA_.cast_struct x
            ...
            let member_init x =
              ...
              let () =
                BA_.set_opt_discriminant data
                  (Some { BA_.Discr.value = 1; BA_.Discr.byte_ofs = 16 })
              in
              let () = BA_.set_int64 ~default:0L x 8 0L in
              let () = BA_.set_int16 ~default:0 x 18 0 in
              BA_.cast_struct x
            ...
            let end_byte_get x = BA_.get_uint32 ~default:Stdint.Uint32.zero x 4

            let end_byte_get_int_exn x =
              Capnp.Runtime.Util.int_of_uint32_exn (end_byte_get x)

            let end_byte_set x v =
          ...
          let has_identifiers x = BA_.has_field x 0

          let identifiers_get x =
            BA_.get_struct_list ~data_words:3 ~pointer_words:0 x 0

          let identifiers_get_list x = Capnp.Array.to_list (identifiers_get x)
          let identifiers_get_array x = Capnp.Array.to_array (identifiers_get x)

          let identifiers_set x v =
            BA_.set_struct_list ~data_words:3 ~pointer_words:0 x 0 v

          let identifiers_init x n =
            BA_.init_struct_list ~data_words:3 ~pointer_words:0 x 0 n

          let identifiers_set_list x v =
            let builder = identifiers_init x (List.length v) in
            let () = List.iteri (fun i a -> Capnp.Array.set builder i a) v in
            builder

          let identifiers_set_array x v =
            let builder = identifiers_init x (Array.length v) in
            let () = Array.iteri (fun i a -> Capnp.Array.set builder i a) v in
            builder
        ...
        let has_filename x = BA_.has_field x 0
        let filename_get x = BA_.get_text ~default:"" x 0
        let filename_set x v = BA_.set_text x 0 v
        let has_imports x = BA_.has_field x 1
        ...
        let has_file_source_info x = BA_.has_field x 2

        let file_source_info_get x =
          BA_.get_struct ~data_words:0 ~pointer_words:1 x 2

        let file_source_info_set_reader x v =
          BA_.set_struct ~data_words:0 ~pointer_words:1 x 2 v

        let file_source_info_set_builder x v =
          BA_.set_struct ~data_words:0 ~pointer_words:1 x 2 (Some v)

        let file_source_info_init x =
          BA_.init_struct ~data_words:0 ~pointer_words:1 x 2
      ...
      let has_capnp_version x = BA_.has_field x 2
      ...
      let nodes_get x = BA_.get_struct_list ~data_words:6 ~pointer_words:6 x 0
      let nodes_get_list x = Capnp.Array.to_list (nodes_get x)
      let nodes_get_array x = Capnp.Array.to_array (nodes_get x)

      let nodes_set x v =
        BA_.set_struct_list ~data_words:6 ~pointer_words:6 x 0 v

      let nodes_init x n =
        BA_.init_struct_list ~data_words:6 ~pointer_words:6 x 0 n
      ...
      let has_source_info x = BA_.has_field x 3

      let source_info_get x =
        BA_.get_struct_list ~data_words:2 ~pointer_words:2 x 3

      let source_info_get_list x = Capnp.Array.to_list (source_info_get x)
      let source_info_get_array x = Capnp.Array.to_array (source_info_get x)

      let source_info_set x v =
        BA_.set_struct_list ~data_words:2 ~pointer_words:2 x 3 v

      let source_info_init x n =
        BA_.init_struct_list ~data_words:2 ~pointer_words:2 x 3 n

      let source_info_set_list x v =
        let builder = source_info_init x (List.length v) in
        let () = List.iteri (fun i a -> Capnp.Array.set builder i a) v in
        builder

      let source_info_set_array x v =
        let builder = source_info_init x (Array.length v) in
        let () = Array.iteri (fun i a -> Capnp.Array.set builder i a) v in
        builder

      let has_requested_files x = BA_.has_field x 1
